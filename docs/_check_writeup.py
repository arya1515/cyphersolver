...
def check_slug(slug):
    ...
    solved = read(HERE / 'solved.html')
    need_solved = st in ('solved', 'partial')
    item(f'href="{slug}.html"' in solved, 'solved.html row (required for solved/partly read; then recount its short version)',

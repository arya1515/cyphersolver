...
def process(path):
    ...
    if slug == 'index':
        s = fold_findings(s)
        FEATURED =['voynich', 'feuquieres', 'armstrong', 'lucca', 'warsaw', 'richelieu', 'goldbar', 'sunyatsen']

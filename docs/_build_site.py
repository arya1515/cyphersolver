...
PAGES = [
    ...
    dict(slug='catinat1691', label='Catinat 1691', year='1691', y=1691.5, place='Versailles &rarr; Piedmont', st='solved', stt='read',
         ...
         rights='Page images: Bayerische Staatsbibliothek, CC BY-NC-SA'),
    dict(slug='urquhart', label='Urquhart', year='1652&ndash;53', y=1652, place='London', st='partial', stt='octastich rule verified',
         title='Urquhart&rsquo;s Cyphral Octastich &mdash; a book cipher on his own Jewel, verified without the plaintext',
         blurb='Eight lines and a &ldquo;Decagram&rdquo; of numbers on the last leaf of The Jewel (1652), Schmeh&rsquo;s Top 50 no. 28. Vals AI published the rule in August 2026 as a Claude Fable 5.1 result: number k indexes a word on page k, and Urquhart took the first word of the needed initial. That habit is checkable without any plaintext: 231 of 267 aligned numbers are first-occurrence hits against 69 % for the shuffled sequence, and five of eight lines read as a royalist prayer from the public transcription alone. The companion distich claim does not reproduce.',

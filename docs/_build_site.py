...
PAGES = [
    ...
    dict(slug='catinat1691', label='Catinat 1691', year='1691', y=1691.5, place='Versailles &rarr; Piedmont', st='solved', stt='read',
         ...
         rights='Page images: Bayerische Staatsbibliothek, CC BY-NC-SA'),
    dict(slug='sormano1529', label='Sormano', year='1529', y=1529, place='Ferrara &rarr; France', st='stuck', stt='key verified, letters unread',
         title='Sormano and Passano from Ferrara &mdash; a key recovered, a sheet found, and a warning',
         blurb='Three ciphered letters of Fran&ccedil;ois I&rsquo;s agents at Ferrara in February 1529, with two glossed siblings in the same volume that should have made it an afternoon&rsquo;s work. The key is recovered and verified on 22 values &mdash; 17 of 21 letters against a twin letter&rsquo;s own wording, and <em>chiaro</em> read blind &mdash; but the letters are not read: eight approaches fail because the hand uses forms that differ by less than the microfilm records. What came out instead is documentary: the lost third sheet of no. 63, bound out of order with the date and signatures thought missing; the duplicate that enciphers different stretches and so cribs its twin; &ldquo;Joachim de Vaulx&rdquo; identified as Gian Gioacchino de Passano; and the embassy&rsquo;s real business, a projected Italian league, fixed from the King&rsquo;s own letters. Plus a caution: language-model decoding fills the unread conclusion with fluent invented Italian.',
         quote='&ldquo;mi parue quasi <em>chiaro</em>&rdquo; &middot; 161 glyphs for 161 crib letters &middot; margin 0.017',
         rights='Manuscript rights: Biblioth&egrave;que nationale de France'),
    ...
    dict(slug='bethune', label='B&eacute;thune 1601', year='1601', y=1601, place='Paris &rarr; Rome', st='partial', stt='one of three read',
         title='Henri IV to B&eacute;thune, 9, 10 and 22 November 1601 &mdash; the 10 November letter read through its minute',
         blurb='Three ciphered letters of the King to his ambassador in Rome, BnF fr. 3484, catalogued &ldquo;avec chiffre&rdquo; with no decipherment. The notice&rsquo;s &ldquo;copie du n&deg; pr&eacute;c&eacute;dent&rdquo; turns out to be the minute of the 10 November letter in clear; aligning it with the cipher, with the marginal decipherments of the neighbouring letters, recovers a Villeroy-office key of the design Bazeries printed for B&eacute;thune&rsquo;s brother in 1599: ten thousand &eacute;cus to Cardinal Aldobrandini for the Peace of Lyon, ten thousand more promised, the Duchess of Nemours&rsquo; arr&ecirc;t disregarded. The 9 November letter reads by half, the 22 November letter not yet.',

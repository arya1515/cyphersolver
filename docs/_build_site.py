...
PAGES = [
    ...
    dict(slug='solved', label='What has been read', year='catalogue', y=9998, place='Catalogue', st='partial', stt='solved catalogue',
         ...
         blurb='Twenty ciphers solved, read or partly read, from a Neapolitan letter of 1497 to a Swatow telegram of 1916, each with the thing that actually broke it, and an account of what a frontier AI did well on the way and where it stopped.',

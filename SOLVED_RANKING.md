...
| p24 | **Henri IV → Maisse**, BnF fr. 16093 ff. 370, 373, 406, 410 | 1592–93 | 2 | 4 | 5 | 4 | 3 | 5 | **3.85** | A published key that nobody had applied, recovered from image files a text dump hides, then checked letter-for-letter against a clear copy found by a separate route; low on difficulty, high on novelty and verification |

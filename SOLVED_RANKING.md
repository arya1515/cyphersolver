...
Ayala to Cisneros 1516 provisional score: 0.25×1 + 0.25×3 + 0.20×5 + 0.10×2 + 0.10×1 + 0.10×2 = **2.50** (p84): a Non-decrypted DECODE letter read two thirds with a published sibling key.

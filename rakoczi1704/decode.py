"""Apply the Fasc. 44/08 codebook (DECODE R639) to R922, R852, R912, and (as a control) R483."""
...
for fn,sup,out in (("DOC_R922_D1861_1861.txt",False,"R922_key08_read.txt"),("DOC_R483_D2172_2172.txt",False,"R483_key08_read.txt"),("DOC_R852_D2171_2171.txt",False,"R852_key08_read.txt"),("DOC_R912_D2230_2230.txt",False,"R912_key08_read.txt")):
    d,g=decode_document(fn,sup); (ROOT/out).write_text(d,encoding="utf-8")
    k=sum(1 for x in g if x in load_key()); print(out,sup,k,len(g))

...
| 17 | Switzerland telegram ("BLUME SALAMANCA") | 1937 | Hard | active | `blume/` | Spanish transposition (IC 0.070). 2026-09-15 second session: double columnar excluded by the validated C# solver, same key widths 2-30 and two keys 2-16 x 2-16 in the forward direction (best -5.9 per quadgram against -3.9 for Spanish, -6.3 shuffled); reversed direction and IDP for widths 15-25 in progress. See `blume/NOTES.md` |
...
| 24 | Feuquières → Catinat, Pignerol, 25 Jan 1691 (Mémoires de Catinat 1819, t. II pp. 283-284; cryptiana "Cipher Despatch received by General Catinat (1691)") | 1691 | Hard | attempted, not solved | `feuquieres/` | 2026-09-15: ciphertext collated with the BSB page images (three corrections to Tomokiyo's copy: 285, 259, 135): 418 groups, 160 distinct, max 366. Subject fixed by the 1819 editor and by Catinat's papers: Feuquières' arrangements for the surprise of Veillane (Avigliana) set for 27 Jan, answering Catinat's 19 Jan "Mémoire pour l'entreprise de Veillane" (Lettres inédites des Feuquières V, 1845). Design: 46 % of tokens on groups below 100 (letters with 2-3 homophones), syllables and words above, no step-10 column structure (P = 0.16): a two-part "petit chiffre" of the Louvois type, same profile as the 1702 Catinat letter. Annealer (7-gram French LM, crib bonus) and a word-segmentation variant both fail a matched 418-group control: 4-12 % recovered, wrong keys outscore the true key by 150-1400 nats under every weighting; with 60 % of the true code given, the solver still recovers only 63 % of the rest. No reading reported. Burgaud and Bazeries 1893 read in full (Gallica PDF): p. 37 lists the letter among those nobody had read, p. 272 n. 1 says Bazeries deciphered it and that the petit chiffre of 1691 had **367 groups** (observed max 366); neither the text nor the table is printed. Needs Bazeries' papers at the SHD (Vincennes; his decodes may sit on Archives du dépôt de la guerre vols. 1032-1099) or a second letter in the code |
...
| ~~William Perwich~~ **FOUND SOLVED (Oct 2025), reproduced 2026-09-15** | 1670 | Broken by Matthew Brown and independently by Lasry/Biermann/Tomokiyo (TNA blog 14 Oct 2025): 20-column transposition with nulls. This tracker had claimed substitution - wrong, the q nulls drove the chi-squared (106 of 160; plaintext cells alone give 28). Reproduced from Tomokiyo's transcription: rows 2-21 are the columns, rows 1 and 22 null lines, key `15 20 19 17 18 21 16 14 2 4 3 5 6 7 13 12 11 10 9 8` found by keyless quadgram climb, 414 plaintext cells. Only nomenclator numbers open. See `perwich/NOTES.md` |

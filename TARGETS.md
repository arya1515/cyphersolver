...
| 3 | Debosnys, 1882-83 | **high** | **ATTEMPTED 2026-09-15.** Glyph composition is prior art (Sektu 2017: 1,188 glyphs / 425 types, sub-glyph grammar, French-syllable hypothesis; transcription unreleased). New: the 20-line *monographe verse* is rhyming couplets - final glyph identical within 9/10 couplets, 0/9 across boundaries (chance <1e-5); 11-17 glyphs/line vs ~12 syllables in his clear French verse, so glyphs are phonetic syllable-sized units. Next: shape search of French verse for a 20-line couplet poem with rhyme 1 = rhyme 9. See `debosnys/NOTES.md` |

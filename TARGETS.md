...
| 3 | Debosnys, 1882-83 | low | **SOLVE ATTEMPTED 2026-09-15, not solved.** Monographe verse (279 glyphs) and No. 10 block (99) transcribed (`verse_transcription.py`, `n10_transcription.py`). Couplet rhymes + 13.9 glyphs/line => French syllabary (English syllables fit the rhymes at p~3e-4). Cribs excluded with validated controls: No. 10 block != clear poem below it; no match in 7,821 French couplet windows (28 vols), Delille Aeneid V, Moore; letter-monogram reading gives no signal. Next: transcribe No. 9 (~400 glyphs, H.D.D.L.M.F. crib), search popular French verse. See `debosnys/NOTES.md` |

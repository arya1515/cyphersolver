...
json.dump({'counts':{t:dict(c) for t,c in counts.items()},'nulls':dict(nulls)},open(os.path.join(HERE,'key1573.json'),'w'),indent=0)
with open(os.path.join(HERE,'align_out.txt'),'w',encoding='utf-8') as f:

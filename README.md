...
- **Catalogue of new targets:** [CATALOGUE.md](CATALOGUE.md) — 25 undeciphered letters, 1497–1610, absent from the standard lists, harvested from the BnF catalogue on Gallica and from the fine print of the cryptiana articles; shelfmarks, arks, prior art, difficulty class. Five have since been taken to the leaf here (Lanssac read, Raince, Béthune and Nevers partly read, du Bellay found in print) and are listed apart; 20 remain open, unvalidated on the leaves except fr. 16127.

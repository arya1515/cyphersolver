...
| Sormano and Passano (Ferrara) → François I, 23 and 27 Feb 1529 (BnF fr. 3096 nos. 63, 65, 66) | 1529 | **Attempted, not read** (18 Sept 2026): key recovered and verified on 22 glyph values — 17 of 21 letters against the exact wording of the twin letter no. 66, and *chiaro* read blind — but the letters are not deciphered. Eight approaches fail at one measured cause: the hand uses forms differing by less than the 1960s microfilm records, 50–60 px per glyph, native resolution confirmed maxed. Language-model decoding returns fluent invented Italian, recorded as a caution. Documentary findings: no. 63's lost third sheet is f. 123 (numbered "3", dated "penultimo de Febraro M D XXVIIII", signed, docket on f. 123v), so the letter is complete and the catalogue's "28 Feb" is a day out; no. 66 enciphers different stretches from no. 65, so the duplicate cribs its twin; no. 64 has no cipher; f. 116v carries a third unrecorded gloss. "Joachim de Vaulx" identified as Gian Gioacchino de Passano; the embassy's charge fixed from the King's own letters as a projected Italian league, not the kingdom of Naples. One document would finish it: fr. 2974 fo. 94 (matrix S 39769) | [`sormano1529/`](sormano1529/) · [write-up](https://dbourdeau.github.io/cyphersolver/sormano1529.html) |
| Phelipeaux d'Herbault → Philippe de Béthune (Rome), 13 Feb 1626 (BnF fr. 3669 no. 25) | 1626 | **Resolved and read** (18 Sept 2026): the catalogue's "one letter without decipherment among ~30 of 1625–26" is not an undeciphered text. No. 26 is not a second letter but the same letter of 13 February, carrying the same cipher with the plaintext written between the lines by a contemporary decipherer; the clear text of the two copies runs word for word, the cipher stands at the same points, and no. 25's first run opens `to 92 … 17 … 43` and its third ends `… 68 93 …` exactly as no. 26's does. The letter reads in full: the Legate's departure for Spain and "le Pape pour l'acheminement de ces troupes in la Valteline", the fear "sy le Pape entroit dans la partialité"; the peace with the Huguenots, needed because "le faix d'une double guerre ne se pouvoit plus supporter"; the Dutch ships withdrawn and the Huguenot admiral following "avec le reste de sa flotte" without the King's permission; and the prince of Piedmont's propositions, which "tendent à engager le Roy à la guerre avec l'Espagne, (et que) la Seigneurie de Venize contribue comme faict l'Angleterre et Holande" — the Savoyard push Monzón defeated six weeks later | [`herbault1626/`](herbault1626/) |

...
| Lanssac → Charles IX, Warsaw, 26 Apr 1573, BnF fr. 4735 no. 51 f. 124 (catalogue item 3, class A) | 1573 | **Read** (17 Sept 2026): both cipher passages (96/100 signs) from the Gallica images. Homophonic letter cipher with word signs (et, nt, st, de, ou, car, pour, Allemagne); key fixed from the glossed sibling f. 154v ("car je n'ay pas cinquante escuz"), the marginal fragments on f. 124, and a pinned annealer that reads gloss words never used as cribs; shuffled-order and blind controls recorded. "Despuis les dangiers qu'encontrent en Allemagne les françois qui passent … j'eusse sans doubte pour le moins esté retenu ou empesché de passer oultre." Tomokiyo's published table for this cipher corrected (first row shifted by one from m; Γ = e, ‡ = d). Four signs and the first word carry a query | [`lanssac/`](lanssac/) |

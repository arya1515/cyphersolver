...
- **Catalogue of new targets:** [CATALOGUE.md](CATALOGUE.md) — 25 undeciphered letters, 1497–1610, absent from the standard lists, harvested from the BnF catalogue on Gallica and from the fine print of the cryptiana articles; shelfmarks, arks, prior art, difficulty class. Eleven have since been taken to the leaf here (Mondoucet, Lanssac, Sormano and the Hesse passages read; Espagnol 318, Raince, Béthune, Nevers and the Forget–Matignon set partly read; du Bellay found in print; Mendoza resolved) and are listed apart; 14 remain open, unvalidated on the leaves except fr. 16127.
...
| Sun Yat-sen's intercepted telegrams, JACAR 特定人ノ発受郵便物取調 (Mar 1916 – Mar 1917) | 1916–17 | 18 Sept 2026 | The Japanese Ministry of Communications' copies of Sun's circle's wires: ~60 condenser telegrams read under seven keys of the Swatow family (Sun ↔ Yamada, Chen Qimei, Qingdao, Manila, San Francisco, Dai Jitao 1917), plus the Hankow +111 digit code; Chen Qimei's assassination as reported to Tokyo; Sun's six-vowel 文密 code still open | [`sunyatsen/y1916/`](sunyatsen/y1916/NOTES.md) · [`sunyatsen/y1917/`](sunyatsen/y1917/NOTES.md) |
...
| Vatican Challenge Part 5 (Farnese → Poggio) | 1542 | 15 Sept 2026 | Identified as an Antonio Elio polyphonic-syllabic cipher; Meister key 176/2 verified from the scan and excluded; letter-, lattice- and unit-level attacks fail against controls. Needs the DECODE images or the key | [`vatican5/`](vatican5/) · [write-up](https://dbourdeau.github.io/cyphersolver/vatican.html) |
